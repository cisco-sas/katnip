...
device_descriptor = Descriptor(
    ...
    fields=[
        UInt8(name='bDesciptorType', value=_DescriptorTypes.DEVICE, fuzzable=True),
        UInt16(name='bcdUSB', value=0x0100),  # USB 2.0 is reported as 0x0200, USB 1.1 as 0x0110 and USB 1.0 as 0x0100
        ...
        UInt16(name='idVendor', value=0),
        UInt16(name='idProduct', value=0),
        UInt16(name='bcdDevice', value=0),
...
device_qualifier_descriptor = Descriptor(
    ...
    fields=[
        UInt8(name='bDesciptorType', value=_DescriptorTypes.DEVICE_QUALIFIER, fuzzable=True),
        UInt16(name='bcdUSB', value=0x0100),  # USB 2.0 is reported as 0x0200, USB 1.1 as 0x0110 and USB 1.0 as 0x0100
        UInt8(name='bDeviceClass', value=0),
        UInt8(name='bDevuceSubClass', value=0),
        UInt8(name='bDeviceProtocol', value=0),
...
configuration_descriptor = Descriptor(
    ...
    fields=[
        UInt8(name='bDesciptorType', value=_DescriptorTypes.CONFIGURATION, fuzzable=True),
        UInt16(name='wTotalLength', value=9),  # TODO: use sizer ?
...
other_speed_configuration_descriptor = Descriptor(
    ...
    fields=[
        UInt8(name='bDescriptorType', value=_DescriptorTypes.OTHER_SPEED_CONFIGURATION, fuzzable=True),
        UInt16(name='wTotalLength', value=0xffff),  # TODO: real default size
...
interface_descriptor = Descriptor(
    ...
    fields=[
        UInt8(name='bDesciptorType', value=_DescriptorTypes.INTERFACE, fuzzable=True),
        UInt8(name='bInterfaceNumber', value=0),
        UInt8(name='bAlternateSetting', value=0),
        UInt8(name='bNumEndpoints', value=0x1),
        UInt8(name='bInterfaceClass', value=0x08),  # 0x08 mass storage
        UInt8(name='bInterfaceSubClass', value=0x06),  # 0x06 mass storage
        UInt8(name='bInterfaceProtocol', value=0x50),  # 0x50 mass storage
...
endpoint_descriptor = Descriptor(
    ...
    fields=[
        UInt8(name='bDesciptorType', value=_DescriptorTypes.ENDPOINT, fuzzable=True),
        UInt8(name='bEndpointAddress', value=0),
        BitField(name='bmAttributes', value=0, length=8),
        UInt16(name='wMaxPacketSize', value=65535),
...
string_descriptor = Descriptor(
    ...
    fields=[
        UInt8(name='bDescriptorType', value=_DescriptorTypes.STRING, fuzzable=True),
...
hub_descriptor = Descriptor(
    name='hub_descriptor',
    fields=[
        UInt8(name='bDesciptorType', value=_DescriptorTypes.HUB, fuzzable=True),
...
SCSI_op_code_0x03 = Template(
    ...
    fields=[
        ...
        UInt32(name='Information', value=0x00),
        SizedPt(name='Additional_Sense_data',
                fields=[
                    UInt32(name='CmdSpecificInfo', value=0x00),
...
SCSI_op_code_0x1a_or_0x5a = Descriptor(
    ...
    fields=[
        ...
        SizedPt(name='Mode_Parameter_Container',
                fields=RandomBytes(name='Mode_Parameter', min_length=0, max_length=4, value='\x1c'))
    ])
...
SCSI_op_code_0x23 = Template(
    ...
    fields=[
        UInt32(name='capacity_list_length', value=0x8),
        UInt32(name='num_of_blocks', value=0x1000),
        UInt16(name='descriptor_code', value=0x1000),
        UInt16(name='block_length', value=0x0200)
    ])
...
SCSI_op_code_0x25 = Template(
    ...
    fields=[
        UInt32(name='NumBlocks', value=0x4fff),
        UInt32(name='BlockLen', value=0x200)
    ])
...
cdc_header_functional_descriptor = Descriptor(
    ...
    fields=[
        UInt8(name='bDesciptorType', value=_DescriptorTypes.CS_INTERFACE, fuzzable=True),
        UInt8(name='bDesciptorSubType', value=_CDC_DescriptorSubTypes.HEADER_FUNCTIONAL),
        UInt16(name='bcdCDC', value=0xffff)
    ])
...
cdc_ethernet_networking_functional_descriptor = Descriptor(
    ...
    fields=[
        ...
        UInt16(name='wMaxSegmentSize', value=1514),
        UInt16(name='wNumberMCFilters', value=0),
...
adc_header_descriptor = Descriptor(
    ...
    fields=[
        ...
        UInt16(name='bcdADC', value=0x0100),
        UInt16(name='wTotalLength', value=0x1e),
...
adc_input_terminal_descriptor = Descriptor(
    ...
    fields=[
        ...
        UInt16(name='wTerminalType', value=0x0206),  # termt10.pdf table 2-2
        UInt8(name='bAssocTerminal', value=0x00),
        UInt8(name='bNrChannels', value=0x01),
        UInt16(name='wChannelConfig', value=0x0101),
...
adc_output_terminal_descriptor = Descriptor(
    ...
    fields=[
        ...
        UInt8(name='bTerminalID', value=0x00),
        UInt16(name='wTerminalType', value=0x0307),  # termt10.pdf table 2-3
        UInt8(name='bAssocTerminal', value=0x00),
...
adc_as_interface_descriptor = Descriptor(
    ...
    fields=[
        ...
        UInt16(name='wFormatTag', value=0x0001)
    ])
...
#     s_byte(name='bDesciptorType', value=_DescriptorTypes.INTERFACE, fuzzable=False)
